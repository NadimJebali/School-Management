...
const TeacherListPage = () => {
  const renderRow = (item: Teacher) => (
    ...
    >
      ...
      <td className="hidden md:table-cell text-[#1F2937]">{item.teacherId}</td>
      <td className="hidden md:table-cell text-[#1F2937]">{item.subjects.join(", ")}</td>
      <td className="hidden md:table-cell text-[#1F2937]">{item.classes.join(", ")}</td>
